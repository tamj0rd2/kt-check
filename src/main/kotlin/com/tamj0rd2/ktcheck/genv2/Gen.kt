 ...
 */
sealed class Gen<T> {
    internal abstract fun generate(tree: ChoiceTree): GenResult<T>
 ...
 * Shrinks are represented as a sequence of [ChoiceTree]s, allowing for lazy evaluation and efficient traversal.
 */
internal data class GenResult<T>(val value: T, val shrinks: Sequence<ChoiceTree>)

private class CombinatorGenerator<T>(private val generator: (ChoiceTree) -> GenResult<T>) : Gen<T>() {
    override fun generate(tree: ChoiceTree): GenResult<T> = generator(tree)
}
