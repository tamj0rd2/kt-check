...
sealed class Gen<T> {
    ...
    internal fun generateWithShrunkValues(tree: ProducerTree): Pair<T, List<T>> {
    ...
    companion object {
         ...
         */
        fun <T> Gen<T>.sample(seed: Long = Random.nextLong()): T = generate(ProducerTree.new(Seed(seed))).value
    }
}
