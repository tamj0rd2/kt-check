 ...
 */
sealed class Gen<T> {
    internal abstract fun generate(tree: ValueTree): GenResult<T>
    ...
    companion object {
         ...
         */
        fun <T> Gen<T>.sample(seed: Long = Random.nextLong()): T = generate(ValueTree.fromSeed(seed)).value
    }
}

/**
 * The result of generating a value from a generator, including the generated value and its shrinks.
 * Shrinks are represented as a sequence of [ValueTree]s, allowing for lazy evaluation and efficient traversal.
 */
internal data class GenResult<T>(val value: T, val shrinks: Sequence<ValueTree>)
